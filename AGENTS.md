...
This file serves as the project constitution for Claude Code agents working in this repository. It defines the immutable principles that govern how all agents operate within this project.
